...
public class RingtoneManagerAdapter extends RecyclerView.Adapter<RingtoneManagerAdapter.RingtoneViewHolder> {

    public int selectedItem = -1;
    private Context context;
    private ArrayList<Ringtone> ringtoneList;

    public RingtoneManagerAdapter() { }

    public RingtoneManagerAdapter(Context context, ArrayList<Ringtone> ringtoneList) {
    ...
    @NonNull
    @Override
    public RingtoneManagerAdapter.RingtoneViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RingtoneManagerAdapter.RingtoneViewHolder holder, int position) {
